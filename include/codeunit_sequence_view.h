...
namespace ostr
{
	...
	public:
		...
		[[nodiscard]] constexpr u64 index_of(const char codeunit, const u64 from = 0, const u64 size = SIZE_MAX) const noexcept;
	...
	constexpr codeunit_sequence_view::codeunit_sequence_view(const char& c) noexcept
	...
	constexpr codeunit_sequence_view::const_iterator::const_iterator(const char* v) noexcept
		: value{ v }
	{ }
